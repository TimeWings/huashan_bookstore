						...
						<div class="topD">
							<div class="topf text-center">
								...
								<c:if test="${empty user }">
									<a href="Login.jsp" target="_parent" style="background-color: lightskyblue; border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; border-radius: 15px;">
										<%="登录"%>
									</a>
								</c:if>
